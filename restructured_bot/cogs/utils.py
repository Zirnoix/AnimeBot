...
class Utils(commands.Cog):
    ...
    async def help_command(self, ctx: commands.Context) -> None:
        ...
        embed.add_field(name="Quiz & Duel", value="`!animequiz [difficulté]`, `!animequizmulti [N]`, `!duel @ami`, `!quiztop`, `!myrank`", inline=False)
        embed.add_field(name="Statistiques", value="`!mystats`, `!stats <pseudo>`, `!monchart [pseudo]`", inline=False)
        embed.add_field(name="Lien AniList", value="`!linkanilist <pseudo>`, `!unlink`, `!duelstats @ami`", inline=False)
        embed.add_field(
            name="Défis & Challenges",
            value="`!weekly`, `!weekly complete`, `!anichallenge`, `!challenge complete <note>`",
            inline=False,
        )
        embed.add_field(
            name="Autres",
